...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc]">
      {/* Top Header */}
      <header className="fixed top-0 left-0 right-0 h-[60px] bg-[#0f172a] z-50 flex items-center justify-between px-4"
      ...
      {/* Sidebar */}
      <aside
        className="fixed left-0 top-[60px] bottom-0 bg-[#0f172a] z-40 flex flex-col transition-all duration-200"
      ...
      >
        ...
        <div className="px-3 py-3 border-t border-white/10">
          <button
            onClick={logout}
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-md text-white/60 hover:bg-white/5 hover:text-white transition-all duration-150"
