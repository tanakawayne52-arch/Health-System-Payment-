...
console.log({start,cardsStart,provinceChartStart,duplicateRiskStart,tableStart,beneficiaryStart});
const modified = src.slice(0,start)
  + src.slice(start,cardsStart)
  + '<div />'
  + src.slice(provinceChartStart,duplicateRiskStart)
  + '<div />'
  + src.slice(tableStart,beneficiaryStart)
  + '\n'
