...
import { Calendar, Plus, Lock, CheckCircle } from 'lucide-react';
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {cycles.map(cycle => (
          <div key={cycle.id} className="bg-white rounded-lg shadow-[0_1px_3px_rgba(0,0,0,0.08)] p-5 hover:shadow-[0_4px_12px_rgba(0,0,0,0.12)] transition-shadow">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-base font-semibold text-[#1e293b]">{cycle.name}</h3>
            ...
            <div className="flex items-center justify-between pt-3 border-t border-[#e2e8f0]">
              <p className="text-xs text-[#475569]">
                Lists: {getPaymentLists().filter(l => l.cycleId === cycle.id).length}
              </p>
